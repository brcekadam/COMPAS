...
enum class MAGNETIC_BRAKING_PRESCRIPTION: int { NONE, RAPPAPORT, CARB, GARRAFFO };
const COMPASUnorderedMap<MAGNETIC_BRAKING_PRESCRIPTION, std::string> MAGNETIC_BRAKING_PRESCRIPTION_LABEL = {
    { MAGNETIC_BRAKING_PRESCRIPTION::NONE,      "NONE" },
    { MAGNETIC_BRAKING_PRESCRIPTION::RAPPAPORT, "RAPPAPORT" },
    { MAGNETIC_BRAKING_PRESCRIPTION::CARB,      "CARB" },
    { MAGNETIC_BRAKING_PRESCRIPTION::GARRAFFO,  "GARRAFFO" }
};
